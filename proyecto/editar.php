<?php
    ...
    $id = $inputRecibido->id;   //Guardamos en una variable nombre el objeto inputrecibido -> nombreForm
        //print_r($id); 
    ...
    switch($method){                        //Con el switch le decimos que si en ese array hay una petición "POST" haga los siguiente:
        ...
        $consulta = 'UPDATE Usuarios SET nombre="'.$nombre.'",correo="'.$correo.'",edad='.$edad.',contrasenya="'.$contrasenya.'" WHERE id='.$id.';';  //Guardamos en una variable la consulta
